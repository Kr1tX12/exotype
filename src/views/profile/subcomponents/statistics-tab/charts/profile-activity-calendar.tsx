...
import { getDateDifference } from "@/shared/lib/utils/getDateDifference";
...
export const ProfileActivityCalendar = () => {
  const { data: typingPerDay, isLoading, error } = useQuery(TypingPerDayAPI.getTypingPerDayQueryOptions());
