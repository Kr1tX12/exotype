  ...
  return (
    <TypingRefsProvider>
      ...
      <motion.p
        ...
        className="pointer-events-none text-muted-foreground font-semibold text-xl absolute left-1/2 top-1/2 -translate-x-1/2 translate-y-1/2 flex gap-2 items-center"
      >
        <MousePointerClick />
        Click to focus
      </motion.p>
